...
function agd_setup() {
	 ...
	 * If you're building a theme based on agd, use a find and replace
	 * to change 'agd' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'agd', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'agd' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'agd_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif;
add_action( 'after_setup_theme', 'agd_setup' );
 ...
 */
function agd_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'agd_content_width', 640 );
}
add_action( 'after_setup_theme', 'agd_content_width', 0 );
 ...
 */
function agd_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'agd' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
add_action( 'widgets_init', 'agd_widgets_init' );
...
function agd_scripts() {
	...
	wp_enqueue_script( 'custom-js', get_template_directory_uri() . '/js/customizer.js', array(), '20120206', true );
	
	wp_enqueue_script( 'responsive-slides', get_template_directory_uri() . '/js/responsiveslides.min.js', array(), '20120206', true );
...
add_action( 'wp_enqueue_scripts', 'agd_scripts' );
